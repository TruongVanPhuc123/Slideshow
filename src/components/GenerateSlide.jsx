    ...
    <div className="flex justify-center items-center mb-6">
      ...
      <div className="flex items-center ml-4 bg-white/50 backdrop-blur-sm px-4 py-2 rounded-lg shadow-sm">
        ...
        <input
          ...
          className="w-28 px-3 py-1.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-colors bg-white"
          min="1"
          max="60"
          step="1"
        />
